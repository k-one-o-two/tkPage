<template>
  <Article :art="ascii.uncrap" :title="note.title" :html="note.html" />
</template>
...
<div>
  ...
  <p>Disclaimer: the whole contents of this page is my personal opinion.</p>
  <p>
    Well, you have to take good pictures and avoid taking bad ones. But what
    makes a picture a good one?
  </p>
  <p>
    I think there are 2 separate metrics, not really connected: how much the
  ...
  <p>
    ...
    will claim to like something completely different, but <s>who cares</s>
    I'm talking about the majority here. So, what are those things?
  </p>
  <h3>Nature</h3>
  <p>
    <a href="https://www.youtube.com/watch?v=3YTd2eoW5ys">We are animals</a>
  ...
  <p>
    Therefore, nature & wildlife pictures mostly always look good. Just get
    yourself a telephoto lens and go find some cute animals:
  </p>
  ...
  <p>
    ...
    easier than shooting bunnies as buildings tend to stay in place, and to
    be built in a way that makes it easy to look at them and take pictures.
  ...
  <p>
    ...
    too much, which I hope I did not. Now, let's use a search engine to look
    for other pictures of that place:
  </p>
  <NoteImage src="/4/2.png"></NoteImage>
  <p>
    Have you noticed it? No? I've inserted the picture above into this one
    and it looks as if it was there (well, I hope so at least). Which means
    that this is not an interesting picture - everyone can get the same one,
    most likely yours won't be the best from a technical point of view.
  </p>
  <p>
    ...
    , but this one is mine". And it might be fine, but unless you can afford
    traveling really often, you will soon run out of landmarks in your city.
  </p>
  ...
  <p>
    Nature photos, even if you're infinitely far from NatGeo photographers,
    are better in this regard, especially for city-dwellers. But how can we
    improve it?
  </p>
  <h3>Lighting</h3>
  <p>
    Technically, we're not taking pictures of objects. We capture some light
    that has been reflected by them, sometimes we capture <i>just</i> the
    light itself - think of shooting stars or auroras or a rainbow.
  </p>
  <p>
  ...
  <p>
    These images would be way less interesting if not the sunset that colors
    the sky and clouds in this nice yellow.
  </p>
  <p>
  ...
  <p>
    Well, lights to the rescue! It might be a good idea to let the sunlight
    in your lens. It really helps during the winter, when there's not enough
    colors.
  </p>
  ...
  <p>
    ...
    reduce the visibility, it affects artificial lights making them softer.
  </p>
  ...
  <p>
    ...
    a lot of people can take a picture of this same place, but you had to be
    there in the correct time to see it all covered with the fog.
  </p>
  <p>
  ...
  <p>
    Even more extreme example - this is literally a picture of light rays in
    the fog. I think this picture gets pretty low aesthetic score, but
  ...
  <p>
    ...
    what's harder. For the 1st one you might need special equipment: either
    lights or flashes, or lots of luck.
  </p>
  <NoteImage src="/4/11.jpg"></NoteImage>
  <p>
    This picture was taken without any special light sources, but conditions
    were really good otherwise - a lot of sunlight and a white wall without
  ...
  <p>
    ...
    portraits. Which is really limiting and you may run out of ideas pretty
    soon.
  </p>
  <p>
  ...
  <p>
    ...
    photographing random people (especially minors) and then uploading those
    pictures!
  </p>
  ...
  <h3>Conclusion</h3>
  <p>
    So, the picture should score some points of being interesting and being
    aesthetic. If it is only good in one of these two things - there's a
