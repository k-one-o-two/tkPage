<template>
  <Article :art="ascii.bike" :title="note.title" :html="note.html" />
</template>
      ...
      note: {
        ...
        html: `
          <div>
            ...
            <p>
              The left-most bike is a time trial bike - it is designed for road racing
              without a mass start, meaning that it's good for going as fast as
              possible on a smooth road without the need to even be aware of the
              surroundings. Commuting on it is like driving a le mans prototype to a
              grocery store.
            </p>
            <p>
              The right-most is a downhill bike. It can survive unimaginable abuse,
              much more than an average rider needs it to. At the same time, it needs
              a gravity to get up to speed, it's not really made for riding up a hill.
              Therefore, it is also not very usable in the city.
            </p>
            <p>
            ...
            <p>
              Although, you don't really want to move further to the right towards a
              DH bike. In the cross country (that's what "xc" stands for btw) you're
